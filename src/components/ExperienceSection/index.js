...
const ExperienceSection = () => (
  <Section title="Experience:">
    <div className="row">
      ...
      <Shuffle logo={lightspeedLogo} colour="#FFFFFF" title="Lightspeed Commerce" link="https://www.lightspeedhq.nl/" timeperiod="Feb 2021 - Jun 2022" description="Working as e Product Engineer on a complete entrepreneurial platform for hospitality, retail and e-Commerce worldwide" />
      <Shuffle logo={silverflowLogo} colour="#FFFFFF" title="Silverflow" link="https://www.silverflow.co/" timeperiod="Jun 2022 - present" description="Working as e Product Engineer on a innovative global payment technology for all payment service providers" />
    </div>
  </Section>
);
