...
const ExperienceSection = () => (
  <Section title="Experience:">
    <div className="row">
      <ExperienceUnit logo={mcaLogo} colour="#FFFFFF" title="MCA" link="https://www.mca.mk/" timeperiod="04.2016 - 06.2017" description="Learnt the ins and outs of product development and
      ...
      <ExperienceUnit logo={inscaleLogo} colour="#FFFFFF" title="InScale" link="https://www.inscale.net/" timeperiod="12.2017 - 08.2018" description="Worked as a Product Engineer on a scandinavian package holidaymaker" />
      <ExperienceUnit logo={inplayerLogo} colour="#FFFFFF" title="InPlayer" link="https://inplayer.com/" timeperiod="08.2018 - present" description="Working as e Product Engineer on a next generation video and digital asset monetization platform" />
    </div>
  </Section>
);
